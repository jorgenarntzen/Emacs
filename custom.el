...
")
 ...
 '(package-selected-packages
   (quote
    (smex smart-mode-line-powerline-theme smart-mode-line session selected rainbow-mode helm-projectile polymode pandoc-mode pabbrev macrostep isearch-dabbrev hydra helm-swoop helm-make helm-descbinds helm flycheck browse-kill-ring+ browse-kill-ring bbdb backup-each-save awk-it avy auto-yasnippet ascii alert lusty-explorer cdlatex auto-complete-auctex jedi elpy python latex-pretty-symbols ebib auctex poporg navi-mode outshine outorg org-bullets org pdf-tools markdown-preview-mode markdown-mode magit lua-mode ledger-mode gnuplot-mode ess csv-mode yari paredit highlight-cl eldoc-extension elisp-slime-nav redshank flx-ido ido-hacks hl-line+ eww-lnum dired-toggle dired-details diredful dired+ bookmark+ zenburn-theme solarized-theme xml-rpc websocket web-server web uuidgen tablist seq rich-minority pyvenv powerline pos-tip popwin popup pkg-info makey log4e let-alist jedi-core helm-core gntp git gh fuzzy f epl epc dash ctable concurrent button-lock anaphora use-package benchmark-init)))
